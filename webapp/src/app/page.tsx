					...
					<div className="flex items-center justify-between gap-8">
						<div className="space-y-8">
							...
							<p className="text-lg text-muted-foreground max-w-xl">
								Créez en quelques minutes un livre illustré personnalisé où vos
								enfants, votre couple ou vos proches vivent une aventure
								magique.
							</p>
						...
						<div className="hidden lg:flex relative -mr-4">
							<Image
								src="/livre.png"
								loading="eager"
								alt="Exemple de livre personnalisé illustré créé avec Book Creator"
								width={1301}
								height={762}
			...
			<section className="relative py-20 lg:py-32 overflow-hidden bg-secondary">
				<div className="container mx-auto px-4 text-center relative z-10">
					...
					<p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
						Rejoignez des milliers de familles qui créent déjà des souvenirs
						uniques.
					</p>
					<Link href="/create-story">
...
export const metadata: Metadata = {
	...
	description:
		"Créez en quelques minutes un livre illustré personnalisé où vos enfants, votre couple ou vos proches vivent une aventure magique. Histoires générées par IA.",
	keywords: [
		"livre personnalisé",
	...
	openGraph: {
		title: "Créer un Livre Personnalisé avec l'IA | Histoires Uniques",
		description:
			"Transformez vos proches en héros d'une histoire inoubliable. Créez un livre illustré personnalisé en quelques minutes.",
		type: "website",
		locale: "fr_FR",
